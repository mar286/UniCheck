...
#         uniFilter <-subset(facilities, Facilities$University == input$University)
#     })
    ...
    output$desc <- renderUI({
      ...
      if (input$ranking == "All") {
        ...
        HTML(paste(all1,all2,all3,all4,all5,all6,all7,all0, sep = '<br/>'))
      }
      
      else if (input$ranking == "Region") {
          rgn1 <- "There are 11 indicators used to compile the QS Asia University Rankings as follows:"
          ...
          HTML(paste(rgn1,rgn2,rgn3,rgn4,rgn5,rgn6,rgn7,rgn8,rgn9,rgn0, sep = '<br/>'))

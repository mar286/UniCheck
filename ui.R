               ...
               tabPanel("Info", icon = icon("info-circle"),
                                   fluidRow(
                                       ...
                                       column(6,
                                              h2(tags$b("How To")),
                                              br(),
                                              h5(p("In Program Finder, user can search for their desired programme simply by selecting the preferred field of study and the location of the university (either West or East Malaysia).
                                                   The result will display all bachelor's degree programmes available together with their expected tuition fees per semester.")),
